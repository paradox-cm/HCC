...
export function PreoperativeClearanceForm() {
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle>Preoperative Clearance Request</CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-6">
        ...
        <fieldset className="space-y-4">
          <legend className="text-lg font-semibold mb-2">Surgical Information</legend>
          <div className="space-y-2">
        ...
        <fieldset className="space-y-4">
          <legend className="text-lg font-semibold mb-2">Medical History</legend>
          <div className="space-y-2">
