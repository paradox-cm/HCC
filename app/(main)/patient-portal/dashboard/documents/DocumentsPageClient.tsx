                ...
                <DialogContent className="sm:max-w-[425px]">
                  ...
                  <form className="space-y-4" onSubmit={handleUpload}>
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button type="submit" size="sm" className="flex-1 bg-red-600 hover:bg-red-700 text-white">Submit</Button>
                      <Button type="button" size="sm" variant="outline" onClick={() => { setShowUpload(false); setUploadError("") }}>Cancel</Button>
                    </div>
                  </form>
                </DialogContent>
              </Dialog>
